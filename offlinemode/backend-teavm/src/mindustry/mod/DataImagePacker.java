...
public class DataImagePacker{
    ...
    private final TeavmSimpleExecutor textureExecutor = Threads.executor("Server Texture Streamer", 1);
    ...
    public void pack(Seq<ImageAsset> images){
        ...
        var sizeTasks = new Seq<TeavmFuture<?>>();
